...
train = pickle.load(open(os.path.join(DATASET_DIR, "train_vgg16_fc1.pickle"), "rb"))
trainingSamples, trainingLabels = preparedata(train)
print("Training set was loaded...")

dev = pickle.load(open(os.path.join(DATASET_DIR, "dev_vgg16_fc1.pickle"), "rb"))
devSamples, devLabels = preparedata(dev)
print("Dev set was loaded...")

test = pickle.load(open(os.path.join(DATASET_DIR, "test_vgg16_fc1.pickle"), "rb"))
...
print(newTrainingLabels.shape, newTrainingSamples.shape)
